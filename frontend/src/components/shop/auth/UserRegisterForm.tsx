  ...
  return (
    <form className="w-full max-w-sm" onSubmit={handleSubmit}>
      ...
      <p className="mt-1 text-[clamp(0.75rem,3vw,0.875rem)] text-text-muted">
        Alışverişe başlamak için hesap oluştur.
      </p>
      ...
      <div className="mt-[clamp(0.75rem,3vw,1rem)] flex items-start gap-2">
        ...
        >
          <a href="#" className="text-secondary hover:underline">Kullanım Şartları</a>
          {"'"}nı ve{" "}
          <a href="#" className="text-secondary hover:underline">Gizlilik Politikası</a>
          {"'"}nı kabul ediyorum.
        </label>
      </div>
