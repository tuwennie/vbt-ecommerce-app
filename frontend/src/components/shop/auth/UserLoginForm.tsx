    ...
    <form className="w-full max-w-sm" onSubmit={handleSubmit}>
      ...
      <div className="mt-[clamp(0.75rem,3vw,1rem)] flex items-center justify-between">
        <div className="flex items-center gap-2">
          <input id="remember" name="remember" type="checkbox" className="h-4 w-4 rounded border-border text-secondary focus:ring-secondary" />
          <label htmlFor="remember" className="text-[clamp(0.75rem,2.5vw,0.875rem)] text-text-main">Beni hatırla</label>
        </div>
        <a href="#" className="text-[clamp(0.75rem,2.5vw,0.875rem)] font-medium text-secondary hover:underline">Şifremi unuttum</a>
      </div>
      ...
      <p className="mt-[clamp(1rem,4vw,1.5rem)] text-center text-[clamp(0.75rem,2.5vw,0.875rem)] text-text-muted">
        Hesabın yok mu?{" "}
        <Link href="/register" className="font-medium text-secondary hover:underline">Kayıt Ol</Link>
      </p>
    </form>
  );
}